...
class VendorsRepository {
  async getOneRepository(params) {
    try {
      const result = await _.from("vendors").where(params).first();
  ...
  async getRepository() {
    try {
      const result = await _.from("vendors").whereNull("deleted_at");
      if (result) return this.success(result, "Data found successfully");
      return this.fail(null, "Data not found");
    } catch (e) {
      return this.fail(e, e.message);
  ...
  async getOneEmailPhoneRepository(params) {
    try {
      const result = await _.from("vendors")
  ...
  async createRepository(params) {
    try {
      const result = await _.into("vendors").insert(params);
  ...
  async updateRepository(params, condition) {
    try {
      const result = await _.from("vendors").update(params).where(condition);
  ...
  async deleteRepository(params) {
    try {
      const result = await _.from("vendors").where(params).del();
      if (result) return this.success(null, "Data created successfully");
      return this.fail(null, "Data created failed");
    } catch (e) {
      return this.fail(e, e.message);
  ...
  async getAllRepository() {
    try {
      const result = await _.select().from("vendors").whereNull("deleted_at");
